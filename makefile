...
libjimmyneuron.a: utilities.o neuron.o neuron_network.o truth_table.o neuron_network_fitness.o random_factory.o evolution.o colony.o parse_cli.o | lib_dir
		ar -crv $(PATH_LIB)/libjimmyneuron.a $(PATH_OBJ)/utilities.o $(PATH_OBJ)/neuron.o $(PATH_OBJ)/neuron_network.o $(PATH_OBJ)/truth_table.o $(PATH_OBJ)/neuron_network_fitness.o $(PATH_OBJ)/random_factory.o $(PATH_OBJ)/evolution.o $(PATH_OBJ)/colony.o $(PATH_OBJ)/parse_cli.o
